  ...
  for(i=644;i<=649;i++){
    (function(i){
      it('has a prefix of ' + i + ' and a length of 16', function(){
        assert(detectNetwork(i.toString().padEnd(16,'1')) === 'Discover');
      });
      it('has a prefix of ' + i + ' and a length of 19', function(){
        assert(detectNetwork(i.toString().padEnd(19,'1')) === 'Discover');
      });
    })(i)
}  
...
describe('Maestro', function() {
  var assert = chai.assert;
  var str1 = '501812345678';
  var str2 = '502012345678';
  var str3 = '503812345678';
  var str4 = '630412345678';

  it('has a prefix of 5018 and a length between 12 and 19',function(){
    for(i=0;i<8;i++){
      assert(detectNetwork(str1.padEnd(12+i,'1')) === 'Maestro');
    }
  ...
  it('has a prefix of 5020 and a length between 12 and 19',function(){
    for(i=0;i<8;i++){
      assert(detectNetwork(str2.padEnd(12+i,'1')) === 'Maestro');
    }
  ...
  it('has a prefix of 5038 and a length between 12 and 19',function(){
    for(i=0;i<8;i++){
      assert(detectNetwork(str3.padEnd(12+i,'1')) === 'Maestro');
    }
  });
  it('has a prefix of 6304 and a length between 12 and 19',function(){
    for(i=0;i<8;i++){
      assert(detectNetwork(str4.padEnd(12+i,'1')) === 'Maestro');
    }
  });
...
describe('China UnionPay', function(){
  var assert = chai.assert;
  it('has a prefix between 622126 to 622925 and a length between 16 and 19', function(){
    for(var prefix = 622126;prefix<=622925;prefix++){
      (function(prefix){
        for(i=16;i<=19;i++){
          assert(detectNetwork(prefix.toString().padEnd(i,'1'))==='China UnionPay');
        }
      })(prefix)
    }
  });
  it('has a prefix between 624 to 626 and a length between 16 and 19', function(){
  ...
  it('has a prefix between 6282 to 6288 and a length between 16 and 19', function(){
